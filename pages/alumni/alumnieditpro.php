                                ...
                                <div class="col-md-12">
                                    <?php 
                                        if (isset($_POST['submit'])){
                                            ...
                                            $update = mysqli_query($conn, "UPDATE tbl_alumni SET
                                            ...
                                            if ($update) {
                                                echo    '<div class="alert alert-success alert-dismissible fade show" role="alert"><strong>Success!</strong> Edit data.'.
