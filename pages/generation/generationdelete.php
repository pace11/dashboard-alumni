            ...
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="card card-accent-primary">
                        <div class="card-header">Delete Data Generation</div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                        Sure delete this data ?
                                        <form action="?page=generationdelete" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="id" value="<?= $_GET['id'] ?>">
                                            <input type="submit" name="submit" class="btn btn-danger" value="Yes">
                                            <a href="?page=generation" class="btn btn-primary">No</a>
                                        </form>
                                    </div>
                                    <?php 
                                        if (isset($_POST['submit'])){
                                            ...
                                            $delete     = mysqli_query($conn, "UPDATE tbl_generation SET deleted_at = NULLIF('$datenow', '') WHERE id='$id'");
                                            if ($delete){
