            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6">
                    <div class="card card-accent-primary">
                        ...
                        <form action="?page=generationaddpro" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="name">Year Generation</label>
                                            <input class="form-control" type="text" placeholder="Year generation ex: 2019-2020" name="year" autocomplete="OFF" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
